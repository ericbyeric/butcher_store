...
<main role="main">
      ...
      <section class="jumbotron text-center">
        <div class="container">
          <h2 class="jumbotron-heading">Pork</h2>
        </div>
      </section>

        <div class="row"><!--Load Pork Products-->
			<?php
				$connect = mysqli_connect('localhost', 'root', '', 'butcherStore'); // connection
				$query = 'SELECT * FROM PRODUCTS,TYPE WHERE PRODUCTS.productId = TYPE.productId AND type="pork"';
	...
	<div class="table-responsive">      <!-- when window is small, table is scrollable -->
		<table class="table">
			...
			<tr>
				...
				<td>
					<a class="mb-2" href="shop_pork.php?action=delete&id=<?php echo $product['id']; ?>">
